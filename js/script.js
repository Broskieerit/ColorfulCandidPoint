...
document.getElementById("aiForm").addEventListener("submit", function(event) {
    ...
    switch (selectedModel) {
        case "gpt4":
            apiUrl = "https://joshweb.click/gpt4";
            break;
        case "gemini":
            apiUrl = "https://joshweb.click/gemini";
            break;
        case "llama":
            apiUrl = "https://joshweb.click/llama-70b";
            break;
        case "gemma":
            apiUrl = "https://joshweb.click/gemma-7b";
            break;
        case "qwen":
            apiUrl = "https://joshweb.click/qwen-72b";
            break;
        default:
            apiUrl = "https://joshweb.click/gpt4";
    }
...
document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("generate-button").addEventListener("click", function (event) {
        ...
        if (selectedModel === "dalle") {
            apiUrl = "https://joshweb.click/dalle?prompt=" + encodeURIComponent(prompt);
        } else if (selectedModel === "dallev2") {
            apiUrl ="https://joshweb.click/dallev2?prompt=" + encodeURIComponent(prompt);s
        } else if (selectedModel === "sdxl") {
            apiUrl = "https://joshweb.click/sdxl?prompt=" + encodeURIComponent(prompt) + "&styles=1";
        } else if ( selectedModel === "openjourney" ) {
            apiUrl = "https://joshweb.click/openjourney?prompt=" + encodeURIComponent(prompt);
        } else if ( selectedModel === "emi" ) {
            apiUrl = "https://joshweb.click/emi?prompt=" + encodeURIComponent(prompt);
        } else if ( selectedModel === "render" ) {
            apiUrl = "https://joshweb.click/render?prompt=" + encodeURIComponent(prompt);
        } else if (selectedModel === "pixart") {
            apiUrl = "https://joshweb.click/pixart?prompt=" + encodeURIComponent(prompt) + "&styles=1";
        } else {
...
async function GetReels() {
    ...
    let apiUrl = "https://joshweb.click/facebook?url=https://web.facebook.com/reel/" + reelId;
